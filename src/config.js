...
export const config = {
    ...
    discordRestTimeoutMs: parseInteger(process.env.DISCORD_REST_TIMEOUT_MS, 3 * 60_000, 15_000, 5 * 60_000),
    discordRestRetries: parseInteger(process.env.DISCORD_REST_RETRIES, 0, 0, 3),
    discordUploadTargetBytes: parseSize(process.env.DISCORD_UPLOAD_TARGET_SIZE, 7 * MB, DISCORD_HARD_MAX_BYTES),
    ...
    maxConcurrentJobs: parseInteger(process.env.MAX_CONCURRENT_JOBS, 2, 1, 16),
    maxQueueSize: parseInteger(process.env.MAX_QUEUE_SIZE, 50, 1, 500),
    maxConcurrentJobsPerUser: parseInteger(process.env.MAX_CONCURRENT_JOBS_PER_USER, 1, 1, 5),
    ...
    cobaltMaxEndpoints: parseInteger(process.env.COBALT_MAX_ENDPOINTS, 3, 1, 10),
    ...
    userAgent: process.env.HTTP_USER_AGENT || "MediaFilez/2.0 (Discord media downloader)",
};
