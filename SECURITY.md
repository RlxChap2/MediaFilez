...
Instagram relay hosts receive the public source URL. Operators can disable them with `INSTAGRAM_PROXY_HOSTS=none` or provide hosts they trust. Cobalt directory discovery stays disabled unless the operator accepts the instance owners' access and privacy rules.
